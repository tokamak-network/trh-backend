...
type StackMetadata struct {
	...
	DeployConfigPath  string `json:"deployConfigPath,omitempty"`
	MonitoringUrl     string `json:"monitoringUrl,omitempty"`
	L2L1CrossTradeUrl string `json:"l2L1CrossTradeUrl,omitempty"`
	L2L2CrossTradeUrl string `json:"l2L2CrossTradeUrl,omitempty"`
}
