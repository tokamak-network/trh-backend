...
// DeriveRoleAccounts derives 4 role accounts from a BIP39 mnemonic.
// Derivation path: m/44'/60'/0'/0/{0,1,2,3}
// Returns hex-encoded private keys (no 0x prefix) for admin, sequencer, batcher, proposer.
func DeriveRoleAccounts(mnemonic string) (admin, sequencer, batcher, proposer string, err error) {
