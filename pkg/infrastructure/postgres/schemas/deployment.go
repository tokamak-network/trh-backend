...
type Deployment struct {
	...
	// Preset-related columns
	PresetID            string         `gorm:"column:preset_id;default:null"`
	SeedDerivedAccounts datatypes.JSON `gorm:"type:jsonb;default:null;column:seed_derived_accounts"`
	FundingStatus       datatypes.JSON `gorm:"type:jsonb;default:null;column:funding_status"`
	ModuleConfigs       datatypes.JSON `gorm:"type:jsonb;default:null;column:module_configs"`
}
