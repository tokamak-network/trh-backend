...
import "trh-backend/pkg/infrastructure/postgres/schemas"

type DeployThanosRequest struct {
	Network                  schemas.DeploymentNetwork `json:"network"                  binding:"required" validate:"oneof=Mainnet Testnet LocalDevnet"`
